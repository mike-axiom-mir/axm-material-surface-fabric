(function () {
  ...
  panel.innerHTML = `
    ...
    <div class="premade-layout">
      ...
      <section class="premade-subpanel">
        <div class="influence-subheading"><strong>Transparent composition</strong><span id="premadeFingerprint">--------</span></div>
  ...
  el.exportPng.addEventListener('click', async () => { await renderPreview(); el.canvas.toBlob((blob)=>blob && download(`${recipe.id}.png`, blob), 'image/png'); });
